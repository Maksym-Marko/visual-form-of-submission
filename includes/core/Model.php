...
class MXVFOS_Model
{
	...
	* Table name
	*/
	protected $table = MXVFOS_TABLE_SLUG;
	...
	*/
	public function mxvfos_get_row( $table = NULL, $wher_name, $wher_value )
	{
	...
	*/
	public function mxvfos_get_results( $table = false, $wher_name = NULL, $wher_value = 1 )
	{
